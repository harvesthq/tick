// Generated by CoffeeScript 1.6.3 forked from harvesthq, novovic edit.
(function() {
  ...
  /*
    ...
    Options
      ...
      maxValue      int       maximum value after the ticker would stop ticking
    ...
    */
    ...
    Tick.prototype.tick = function() {
      ...
      if (this.value >= this.options.maxValue) {
        this.value = this.options.maxValue;
        this.render();
        return this.stop();
      } else {
        this.render();
